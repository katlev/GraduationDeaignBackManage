...
var vm = new Vue({
    ...
    mounted(){
        ...
        //毕业论文列表获取
        let fileUrl = rootPath + '/getThesisFile?limit=20&page=1&schoolYear=' + semester + '&userId=' + admiId
        axios.get(fileUrl,{headers:{'Authorization': admiToken}}).then(res => {
            ...
            res.data.data.forEach(item => {
                ...
                this.thesisList.push(obj)

            })
        })

        //获取统计数据
        let graphicUrl = rootPath + '/thesisGraphic?adminId=' + admiId + '&schoolYear=' + semester
        axios.get(graphicUrl,{headers:{'Authorization': admiToken}}).then(res => {
            //console.log(res)
            this.graphicData.push(res.data.data.stuNum)
            this.graphicData.push(res.data.data.thesisNum)
    ...
    methods:{
        ...
        searchBtn(){
            ...
            let searchUrl = rootPath + '/searchThesisFile?limit=20&page=1&schoolYear=' + semester + '&searchValue=' + searchValue + '&userId=' + admiId
